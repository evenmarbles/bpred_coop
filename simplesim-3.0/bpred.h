 ...
 *
 *  BPredCoop:  Cooperative branch predictor
 *
 *      This predictor has a two levels adaptive branch predictor with
 *      PHT's split into m number of banks, called direction preditors.
 *      A bimodal predictor acts as choice predictor, choosing one of
 *      the direction predictors to use for prediction.
 *
...
enum bpred_class {
    BPredCoop,          /* bi-mode predictor (Lee, Cheng, Chen, Mudge) */
