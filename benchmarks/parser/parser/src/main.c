...
void batch_process(void) {
    ...
    /*HZ: change stdin to a file stream, use f_stdin for stdin */
    f_stdin = fopen("ref.in", "rt");
	...
	/*if (fgets(s, MAX_LINE, stdin) == NULL) break;*//*HZ*/
	if (fgets(s, MAX_LINE, f_stdin) == NULL) break;
	if (s[strlen(s)-1] != '\n') {
