...
/*extern  char *          fgets P(( char *, int, FILE * )); */ /*HZ*/
...
extern  ssize_t             read P(( int, char *, int ));
extern  ssize_t             write P(( int, char *, int ));
#endif
...
#endif
#include <termbits.h>  /*HZ added to define ECHO */
int             syStartraw ( fid )
    long                fid;
{
...
/** * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
**
**  For WIN32 we read directly from the keyboard.
...
/*extern  char *          calloc P(( size_t, size_t ));*/ /*HZ: comment it out */
